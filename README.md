...
<strong>Finance Analyst | CIMA Candidate</strong>
...
- **Financial Forecasting (Regression / Analytics in Excel)**  
  ...
  🔗 [Repository](https://github.com/fardousfa/Financial-Forecasting-using-Regression-Model-Data-and-Analytics)

- **Financial Decision Analysis in Excel (Strategic Pricing Optimization)**  
  Excel-based decision analysis focused on pricing and business strategy  
  🔗 [Repository](https://github.com/fardousfa/Financial-Decision-Analysis-in-Excel)
...
- **Tesco PLC Financial Performance Analysis (FY2022–FY2025)**  
  ...
  🔗 [Repository](https://github.com/fardousfa/Financial-Performance-Analysis-Tesco-PLC-FY-2025-2022)
